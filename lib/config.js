...
export const DEFAULT_MEMORY_JUDGE = Object.freeze({
  ...
  // Let Laya's category answer suggest a capture on ordinary turns. Off by default: on 735 unseen real
  // prompts it fired 40 times and never on a turn that asked to save something. Explicit requests
  // ("记住……", "remember this") are handled by the Fast-Path and still honour proactiveCapture.
  layaCapture: false,
  ...
  decisionLog: true,
  // Match prompts against the Vault's note titles/aliases/tags to catch recalls Laya misses.
  vaultHints: true
});
