...
export class MemoryRouter {
  ...
  async evaluateRecall(text, projectContext = null) {
    ...
    const makeTrace = (route, decision, reason, _hookExecuted, layaAttempted) => ({
    ...
    if (this.config.mode === "off") {
      return {
        ...
        reason: "mode_off",
        blocked: false,
        trace: makeTrace("fallback", "none", "mode_off", true, false)
      };
    }
    ...
    if (fast.action !== "consult_laya") {
      ...
      return {
        ...
        reason,
        blocked: false,
        trace: makeTrace("fast_path", decision, reason, true, false)
      };
    }
      ...
      if (this.discoveryTimer) {
        ...
        if (isStrict) {
          return {
            ...
            captureCategory: null,
            blocked: true,
            reason: "strict_mode_laya_unavailable",
            trace: makeTrace("fallback", "none", "strict_mode_laya_unavailable", true, false)
          };
        }
        return {
          recallRecommended: false,
          ...
          captureCategory: null,
          blocked: false,
          reason: restartScheduled ? "service_restart_scheduled" : "no_trusted_service",
          trace: makeTrace("fallback", "none", restartScheduled ? "service_restart_scheduled" : "no_trusted_service", true, false)
        };
      }
    ...
    if (this._knownServiceProcessIsDead()) {
      ...
      return {
        ...
        captureCategory: null,
        blocked: false,
        reason: restartScheduled ? "service_restart_scheduled" : "service_process_dead",
        trace: makeTrace("fallback", "none", restartScheduled ? "service_restart_scheduled" : "service_process_dead", true, false)
      };
    }
    ...
    if (!this.client) {
      ...
      return {
        ...
        captureCategory: null,
        blocked: false,
        reason: "unconfigured_endpoint",
        trace: makeTrace("fallback", "none", "unconfigured_endpoint", true, false)
      };
    }
    ...
    if (!this.circuitBreaker.canAttempt()) {
      if (isStrict) {
        return {
          ...
          captureCategory: null,
          blocked: true,
          reason: "strict_mode_circuit_breaker_open",
          trace: makeTrace("fallback", "none", "strict_mode_circuit_breaker_open", true, false)
        };
      }
      return {
        recallRecommended: false,
        ...
        trace: makeTrace("fallback", "none", "circuit_breaker_open", true, false)
      };
    }
      ...
      if (
        ...
        if (isStrict) {
          return {
            ...
            captureCategory: null,
            blocked: true,
            reason: "strict_mode_health_handshake_failed",
            trace: makeTrace("fallback", "none", "strict_mode_health_handshake_failed", true, true)
          };
        }
        return {
          recallRecommended: false,
          ...
          captureCategory: null,
          blocked: false,
          reason: "health_handshake_failed",
          trace: makeTrace("fallback", "none", "health_handshake_failed", true, true)
        };
      }
    }
    ...
    try {
      ...
      if (
        ...
        if (isStrict) {
          return {
            ...
            captureCategory: null,
            blocked: true,
            reason: "strict_mode_identity_conflict",
            trace: makeTrace("fallback", "none", "strict_mode_identity_conflict", true, true)
          };
        }
        return {
          recallRecommended: false,
          ...
          trace: makeTrace("fallback", "none", "laya_fallback", true, true)
        };
      }
      ...
      return {
        ...
        reason,
        blocked: false,
        trace: makeTrace("laya", decision, reason, true, true)
      };
    } catch (err) {
      if (
        this.identityGeneration !== callGen ||
      ...
      if (isStrict) {
        return {
          ...
          captureCategory: null,
          blocked: true,
          reason: "strict_mode_laya_error",
          error: err.message,
          trace: makeTrace("fallback", "none", "strict_mode_laya_error", true, true)
        };
      }
      ...
      return {
        ...
        captureCategory: null,
        blocked: false,
        reason: restartScheduled ? "service_restart_scheduled" : "laya_fallback",
        error: err.message,
        trace: makeTrace("fallback", "none", restartScheduled ? "service_restart_scheduled" : "laya_fallback", true, true)
      };
    }
  }
