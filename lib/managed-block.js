...
export const TRIGGER_INSTRUCTION = "For code tasks, use the obsidian-memory skill before working and when persisting durable project memory, unless this turn's Obsidian Memory hint says memory is not needed.";
